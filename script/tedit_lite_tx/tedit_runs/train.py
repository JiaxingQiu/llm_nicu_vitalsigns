from tedit_tx_data import TEditDataset
from tedit_tx_trainer import Trainer
from tedit_tx_model import *
from tedit_tx_generation import tedit_generate
import yaml
...
configs['model']['attrs'] = {
    ...
    "attr_dim": meta['attr_dim'],  # Use attr_dim from meta (768 for mpnet)
    "emb_dim": meta['attr_dim'],      # Use attr_dim from meta
    "text_emb_dim": meta['attr_dim']  # Use attr_dim from meta
}
